...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "<ln147258..+>".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.worklog.asia"];
pub const RS_PUB_KEY: &str = "D2WBJ1RZj70Wl4s1hzRDu0HU2kqr1Sy3W5oiUeQ6Glg=";
